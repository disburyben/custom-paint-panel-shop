...
export const galleryItems = mysqlTable("gallery_items", {
  ...
  // Images
  beforeImageKey: varchar("beforeImageKey", { length: 500 }),
  beforeImageUrl: varchar("beforeImageUrl", { length: 1000 }),
  afterImageKey: varchar("afterImageKey", { length: 500 }),
  afterImageUrl: varchar("afterImageUrl", { length: 1000 }),
  
  // Enhanced Gallery Fields
  vehicleType: varchar("vehicleType", { length: 100 }), // Free text: 'Sedan', 'Motorcycle', 'Van', etc.
  servicesProvided: varchar("servicesProvided", { length: 500 }), // Free text: 'Custom Paint, Wheel Upgrade'
...
export const sprayers = mysqlTable("sprayers", {
  ...
  logoUrl: varchar("logoUrl", { length: 1000 }),
  certifications: text("certifications"), // Line-separated list of certifications
