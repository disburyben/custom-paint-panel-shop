                ...
                {Object.entries(statusLabels).map(([status, label]) => {
                    ...
                    return (
                        <div
                            key={status}
                            className={cn(
                                "bg-card border p-4 rounded-lg cursor-pointer transition-colors",
                                statusFilter === status ? "border-primary" : "border-border hover:border-border/80"
                            )}
                    ...
                    {quoteDetail && (
                        <>
                            ...
                            <div className="space-y-6">
                                ...
                                {/* Service Info */}
                                <div>
                                    <h3 className="font-bold mb-3">Service Request</h3>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
